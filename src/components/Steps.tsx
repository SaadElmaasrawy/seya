    ...
    <section className="relative z-10">
      ...
      <div ref={ref} className="grid grid-cols-[40px_1fr] gap-x-4 px-4 max-w-md mx-auto mt-8">
        ...
        <div className="flex flex-col items-center gap-2 pt-3">
          <div className={`flex items-center justify-center size-10 rounded-full border-2 border-primary bg-primary/20 text-primary scroll-animate ${isVisible ? 'visible' : ''}`}>
        ...
        <div className={`flex flex-1 flex-col py-3 scroll-animate ${isVisible ? 'visible' : ''}`}>
          <p className="text-sm font-medium leading-normal text-primary">{t("Step 1")}</p>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className={`flex items-center justify-center size-10 rounded-full border-2 border-primary bg-primary/20 text-primary scroll-animate animate-delay-100 ${isVisible ? 'visible' : ''}`}>
            <span className="material-symbols-outlined text-2xl">auto_awesome</span>
          </div>
          <div className="w-0.5 bg-[#2a2a32] grow"></div>
        </div>
        <div className={`flex flex-1 flex-col py-3 scroll-animate animate-delay-100 ${isVisible ? 'visible' : ''}`}>
          <p className="text-sm font-medium leading-normal text-primary">{t("Step 2")}</p>
        ...
        <div className="flex flex-col items-center gap-2 pb-3">
          <div className="w-0.5 bg-[#2a2a32] h-2"></div>
          <div className={`flex items-center justify-center size-10 rounded-full border-2 border-primary bg-primary/20 text-primary scroll-animate animate-delay-200 ${isVisible ? 'visible' : ''}`}>
            <span className="material-symbols-outlined text-2xl">send</span>
          </div>
        </div>
        <div className={`flex flex-1 flex-col py-3 scroll-animate animate-delay-200 ${isVisible ? 'visible' : ''}`}>
          <p className="text-sm font-medium leading-normal text-primary">{t("Step 3")}</p>
